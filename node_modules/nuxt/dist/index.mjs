  ...
  async setup(_options, nuxt) {
    ...
    nuxt.hook("nitro:init", (nitro) => {
      ...
      nuxt.hook("nitro:build:before", (nitro2) => {
        if (nitro2.options.prerender.routes.length) {
